...
def do_castling_db(game_num, castling):
    ...
    if castling == "white_short":
        val = [("00", "e1"), ("04", "f1"), ("06", "g1"), ("00", "h1"), ("g1", "white_king")]  # вместо короля/новая ладья/новый король/вместо ладьи/координты короля
    elif castling == "white_long":
        val = [("00", "a1"), ("06", "c1"), ("04", "d1"), ("00", "e1"), ("c1", "white_king")]  # вместо ладьи/новый король/новая ладья/вместо короля/координты короля
    elif castling == "black_short":
        val = [("00", "e8"), ("14", "f8"), ("16", "g8"), ("00", "h8"), ("g8", "black_king")]  # вместо короля/новая ладья/новый король/вместо ладьи/координты короля
    else:  # "black_long"
        val = [("00", "a8"), ("16", "c8"), ("14", "d8"), ("00", "e8"), ("c8", "black_king",)]  # вместо ладьи/новый король/новая ладья/вместо короля/координты короля
